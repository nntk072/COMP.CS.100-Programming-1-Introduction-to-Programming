...
class Userinterface:
    ...
    def __init__(self):
        ...
        self.__result_label = Label(self.__mainwindow, text=NAN)
        ...
        self.__explanation_label = Label(self.__mainwindow, text=NAN)
        ...
        self.__result_label.grid(row=2, column=1)
        self.__explanation_text.grid(row=3, column=0)
        self.__explanation_label.grid(row=3, column=1)
    ...
    def calculate_BMI(self):
        ...
        try:
            ...
            if a > 0 and b > 0:
                ...
                self.__result_label.configure(text=f"{self.__result_numbervalue:.2f}")
            else:
        ...
        self.__explanation_label.configure(text=self.__result_textvalue)
        pass
    ...
    def get_A_and_B_content(self):
        try:
            A_value = float(self.__weight_value.get())
            B_value = float(self.__height_value.get())
